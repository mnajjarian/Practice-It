/*Modify your Stairs program from the previous exercise to make a new class Stairs2 that draws the output shown below. Modify only the body of your loop.
(You may want to make a new table to find the expressions for x, y, width, and height for each new output.)
